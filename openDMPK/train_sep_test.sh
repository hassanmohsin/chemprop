...
#python train.py --data_path $1 --separate_test_path $2 --dataset_type classification --save_dir $3 --split_type scaffold_balanced --ensemble_size 5 --config_path $4 --epochs 100 --batch_size 16 --multiclass_num_classes 1 --num_folds 3 --gpu 2
